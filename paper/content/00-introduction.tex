...
\begin{enumerate}
    ...
    \item \cref{chap:implementation} presents additional algorithm implementations that were not fully detailed in previous chapters, such as matrix inversion and related computational methods.
\end{enumerate}