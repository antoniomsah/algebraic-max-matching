...
\href{https://github.com/antoniomsah/algebraic-max-matching/blob/main/code/solver.hpp#L107}{//code/solver.hpp:L107}.

\subsubsection{Time complexity}
\noindent
Let \(t(G)\) be the total running time of \(\SC{MaximumMatching}(G)\) and \(f(G')\) be the running time of \(\SC{PerfectMatching}(G')\) on the modified graph.
\begin{itemize}
