...
By running the benchmark algorithm and generating box plots with the results. 
The following box plots were generated:
\begin{figure}[h]
\label{fig:v10}
  \centering
  \includegraphics[width=12cm]{boxplot_v10.png}
  \caption{Perfect Matching benchmark with 10 vertices.}
\end{figure}
\begin{figure}[h]
\label{fig:v20}
  \centering
  \includegraphics[width=12cm]{boxplot_v20.png}
  \caption{Perfect Matching benchmark with 20 vertices.}
\end{figure}
\begin{figure}[h]
\label{fig:v50}
  \centering
  \includegraphics[width=12cm]{boxplot_v50.png}
  \caption{Perfect Matching benchmark with 50 vertices.}
\end{figure}
\begin{figure}[h]
\label{fig:v100}
  \centering
  \includegraphics[width=12cm]{boxplot_v100.png}
  \caption{Perfect Matching benchmark with 100 vertices.}
\end{figure}
\begin{figure}[h]
\label{fig:v200}
  \centering
  \includegraphics[width=12cm]{boxplot_v200.png}
